    ...
    <div className='w-full mx-auto p-6 bg-gray-900 text-white rounded-md shadow-mds'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 md:px-16 mb-16'>
        <label className='floating-label m-auto w-sm md:w-md'>
          <span>Nombre Completo <span className='text-rose-600'>*</span></span>
          <input
        ...
        <label className='select select-md m-auto'>
          <span className='label'>Parentesco <span className='text-rose-600'>*</span></span>
          <select
            value={datosPago.responsable}
            onChange={(e) =>
              setDatosPago({ ...datosPago, responsable: Number(e.target.value) })
            }
          >
            <option
              selected
        ...
        <label className='select select-md m-auto'>
          <span className='label'>¿Requiere Factura? <span className='text-rose-600'>*</span></span>
          <select
